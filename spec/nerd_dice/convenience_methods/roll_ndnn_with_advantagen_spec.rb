...
# roll_dNN_with_advantage(N) pattern spec
# Covers situation pattern of /roll_\d+d\d+_with_advantage\d*/
...
# * Examples
#   * roll_3d20_with_advantage2 => roll 3 d20 and take the highest 2
#   * roll_3d8_with_advantage_plus6 => roll 3 d8 and take the highest 2 then add 6
