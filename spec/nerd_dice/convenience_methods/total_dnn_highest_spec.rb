...
RSpec.describe NerdDice::ConvenienceMethods, ".total_dnn_highest" do
  ...
  describe "total_dNN_highest method" do
    ...
    it "responds to methods matching the pattern" do
      expect(magic.respond_to?(:total_d6_highest)).to be(true)
    end
  end
  ...
  describe "total_dNN_highest with bonuses and penalties" do
    it "calls calls NerdDice.roll_dice with correct arguments, keywords with bonus" do
      ...
      magic.total_d20_highest_plus6(**method_options)
    end
    ...
    it "calls calls NerdDice.roll_dice with correct arguments, keywords with penalty" do
      ...
      expect(NerdDice).to receive(:roll_dice).with(20, 2, **merged_options).and_call_original
      magic.total_d20_highest_m5(**method_options)
    end
    ...
    it "responds to methods matching the pattern" do
      expect(magic.respond_to?(:total_d20_highest_minus4)).to be(true)
    end
  end
end
